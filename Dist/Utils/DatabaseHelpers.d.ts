...
export declare function ApplyDBUpdates(options: Partial<FireOptions>, rootPath: string, dbUpdates: Object): Promise<void>;
export declare const maxDBUpdatesPerBatch = 500;
export declare function ApplyDBUpdates_InChunks(options: Partial<FireOptions>, rootPath: string, dbUpdates: Object, updatesPerChunk?: number): Promise<void>;
